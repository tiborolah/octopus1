...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { employment_id: @organisation.employment_id, end_date: @organisation.end_date, name: @organisation.name, start_date: @organisation.start_date }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { employment_id: @organisation.employment_id, end_date: @organisation.end_date, name: @organisation.name, start_date: @organisation.start_date }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
